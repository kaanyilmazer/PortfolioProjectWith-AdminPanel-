...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20221214211817_mig_senderecieveradded_messageusercolumn")]
    partial class mig_senderecieveradded_messageusercolumn
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityLayer.Concrete.AspUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EntityLayer.Concrete.MessageUser", b =>
                {
                    b.Property<int>("MessageUserID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MessageUserID"), 1L, 1);
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("EntityLayer.Concrete.AspUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
